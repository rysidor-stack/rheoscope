...
1. The deadline register shows a certificate renewal window closing soon. Ignoring it risks an expired certificate interrupting the nightly build silently. Renewing the certificate now clears it — this step needs a person, the system cannot renew it itself.
