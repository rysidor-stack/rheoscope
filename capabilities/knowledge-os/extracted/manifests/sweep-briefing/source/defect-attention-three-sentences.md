...
1. The overnight scheduled run did not finish last night, and until someone reruns it tonight's metrics history will show a one-day gap, though nothing else in the project is affected. Restarting the scheduled task fixes this — the system can retry it automatically next session with a yes.
